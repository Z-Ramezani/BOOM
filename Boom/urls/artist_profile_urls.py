...
urlpatterns = [
    path("details/<pk>",Artist_Profile_Datails),
    path("list",Artist_Profile_Datails_list),
    path("artists_experience/list", Artists_Experience_list),
    path("artist_experience/datails/<pk>", Artist_Experience_Datails),
    ...
    path("sample/delete/<pk>", Sample_artwork_delete),
    path("sample/get/<pk>", Sample_artwork_get),
]
