                    ...
                    <div className="col-md-4">
                        <form  className="form-control">
                            ...
                            <div className="mb-3">
                                ...
                                <a className='nav-link' href='#' style={{fontSize:'0.8vw',color:'#222222',marginTop:'0%'}} >بازیابی رمز عبور</a>

                            </div>
                            <div className="mb-3 form-check pull-right">
                                <input type="checkbox"  id="Check1" style={{marginRight:'2%'}} />
                                <label className="form-check-label me-1" data-ng-model="rememberMe">مرا به یاد بسپار</label>
                            </div>
                            <div className="mb-3">
