    ...
    return (
        <div className='d-flex flex-column min-vh-100'>
                    ...
                    <div className='row justify-content-center'>
                        <div class="row position-relative" dir="LTR"  >
                            ...
                            <div class="col-md-6 p-4 ps-md-0" dir="RTL" style={{marginLeft:'7.8%'}}>
                                    ...
                                    <h2 class="mt-3" style={{fontSize:'1.1vw', fontWeight:'bold'}}>راه ارتباطی: {/*recive from back*/}</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className='container w-75 p-3 shadow bg-white rounded mb-5'>
                    <ShowArtworkAdCost/>
                    <h2 class="mt-0 text-danger" style={{fontSize:'110%', fontWeight:'bold', }}> قیمت پیشنهادی کارشناس: {/*recive from back*/}</h2>
                    <br/>
                    <h2 class="mt-0 text-danger" style={{fontSize:'90%', fontWeight:'bold', }}> توضیحات: {/*recive from back*/}</h2>
            </div>  
            <Footer/>
        </div>                    
    );
