...
class ExportArtworkAd extends Component {
    state = {  } 
    render() {
            return (
                <div className="">
                    <div class="row g-0 position-relative" dir="LTR">
                        ...
                        <div class="col-md-6 p-4 ps-md-0" dir="RTL">
                            ...
                            <br/>
                            <h2 class="mt-0" dir="RTL" style={{fontSize:'1.1vw', fontWeight:'bold'}}>{/*recive from back*/} قیمت هنرمند:</h2>
                            <br/>
...
export default ExportArtworkAd;