        ...
        return (
            <div className="row g-0 position-relative" dir="LTR">
                <div className="col-md-6 mb-md-0 p-md-4">
                    <form>
                        <div className="form-group" style={{width:'23vw', height:'23vw', border:'0.11vw solid #e1e1e1', borderRadius:'0.2vw'}}>
                    ...
                    <div className='row justify-content-center'>
                        ...
                        <div className='row mb-2'>     
                            <div className='col row '>
                                ...
                                <div className='col-8'> 
                                    <InputText type="text" placeholder='80*50 سانتی‌متر' value={size} onChange={(e)=>setSize(e.target.value)}/>
                                </div>
                            </div>
                        </div>
                        <div className='row mb-2'>     
                            <div className='col row '>
                                ...
                                <div className='col-8'> 
                                    <InputText type="text" value={method} onChange={(e)=>setMethod(e.target.value)}/>
                                </div>
                            </div>
                        </div>
                        <div className='row mb-2'>     
                            <div className='col row '>
                                ...
                                <div className='col-8'> 
                                    <InputText type="text" value={material} onChange={(e)=>setMaterial(e.target.value)}/>
                                </div>
                            </div>
                        </div>
                        <div className='row mb-2'>     
                                ...
                                <div className='row mb-2'>     
                                    <div className='col row'>
                                        ...
                                        <div className='col-8'style={{width:'64%', fontSize:'1.1vw'}}> 
                                            <InputText type="text" placeholder='تومان' value={cost} onChange={(e)=>setCost(e.target.value)}/>
                                        </div>
                                    </div>
                                </div>
                        </div>
